    ...
    <Animated.View style={[{ bottom: bottomBarFade }, styles.bottomBar]}>
      ...
      >
        <FontAwesome5
          ...
          size={22}
          style={{ opacity: 0.8 }}
          color={solverActive ? "#3e4a4f" : "#cdd0d1"}
        />
        <Text style={[styles.bottomTabText, solverActive ? styles.dark : null]}>
          Solver
        </Text>
      </Ripple>
      <Ripple
      ...
      >
        <FontAwesome5
          ...
          size={22}
          style={{ opacity: 0.8 }}
          color={solvedActive ? "#3e4a4f" : "#cdd0d1"}
        />
        <Text style={[styles.bottomTabText, solvedActive ? styles.dark : null]}>
          Solved puzzles
        </Text>
      </Ripple>
    </Animated.View>
